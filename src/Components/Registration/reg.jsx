        ...
        <div className="woocomerce__signin sec-plr-50">
          <div className="woocomerce__signin-wrapper">
            <div className="woocomerce__signin-titlewrap">
              <span className="woocomerce__signin-title">Registration</span>
            </div>
            <form action="#" onSubmit={handleSubmit} method='post'>
              <div className="woocomerce__signin-field">
                <label htmlFor="Email">Email</label>
                <input type="email" name="email" id="Email" placeholder="Your email" onChange={textHandle} />
              </div>
              <div className="woocomerce__signin-field">
                <label htmlFor="Password">Password</label>
                <div className="woocomerce__signin-passwordfield">
                  <input type="password" name="password" id="Password" placeholder="Password" onChange={textHandle}/>
                </div>
              </div>
              ...
              <div className="woocomerce__signin-btnwrap">
                <button type="submit" className="woocomerce__checkout-submitbtn">Register</button>
              </div>
            </form>
          </div>
        </div>
